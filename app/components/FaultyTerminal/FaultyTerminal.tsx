...
const fragmentShader = `/* shader sama persis seperti punyamu, tidak diubah */ 
...
export default function FaultyTerminal({
  ...
  // Mouse listener pada WINDOW agar interaktif meski tertutup overlay
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      let w = ctn.offsetWidth;
      let h = ctn.offsetHeight;
      // fallback jika parent belum ter-layout
      if (w < 2 || h < 2) {
        w = window.innerWidth;
    ...
    // tempelkan canvas & pastikan ukuran final setelah layout settle
  ...
  return (
    <div
      ref={containerRef}
      aria-hidden
      // fill parent agar selalu kelihatan sebagai background
